...
### Implementation of Emission Impossible's Emission Calculation Methodlogy
...
### Data Source Selection  TODO - incorporate into methodology as a validity/reporting check nad to generate the scheduled UUIDs
...
Firstly, the model estimates the emissions per *trip instance* based on average speed and distance. This level of granularity results in the following factors being excluded from the analysis:
...
- Bus Sizing - contractual sizing is not used
- 
...
- UUIDs for trip instances - makes this sort of task much easier
- Consider introducing operational data standards for public bus data. This will be particulary helpful for the development of enterprise solution for this model. 
