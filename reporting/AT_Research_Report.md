...
The scheduled (GTFS) data only needed to be collected when a version change occurred. This data was joined using the trip_id, route_id, and servce_id to generate an operational data set. This dataset contains the date, vehicle id, route, and the observed trip duration
